var te=Object.defineProperty;var H=e=>{throw TypeError(e)};var ae=(e,t,a)=>t in e?te(e,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[t]=a;var F=(e,t,a)=>ae(e,typeof t!="symbol"?t+"":t,a),G=(e,t,a)=>t.has(e)||H("Cannot "+a);var h=(e,t,a)=>(G(e,t,"read from private field"),a?a.call(e):t.get(e)),x=(e,t,a)=>t.has(e)?H("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,a),V=(e,t,a,n)=>(G(e,t,"write to private field"),n?n.call(e,a):t.set(e,a),a),N=(e,t,a)=>(G(e,t,"access private method"),a);import{C as ne,m as _,p as se,q as M,y as k,E as le,k as re,ax as oe,W as ie,P as ue,f as pe,l as ce,T as de,H as me,A as _e,I as ye,X as $e,ay as j,U as K,a1 as r}from"./app-BzmzFw4g.js";import{e as be,g as fe,h as ve,j as ge,i as Te,k as we,l as he,E as ke,n as Me,o as xe,p as Pe,t as Ee,q as Ce,u as Le,v as Be,w as Se,x as Ae,y as Ie,z as Re,A as De,B as Fe,C as Ge,F as Ve,D as qe}from"./vidstack-D_DrbzHZ-C4W35OEi.js";import{L as Oe,x as s}from"./vidstack-CwTj4H1w-Bp4ARBvF.js";import{S as He,$ as l,L as Ne,I as Qe,o as U}from"./vidstack-7xep0lg7-B26L3iXW.js";import{MediaPosterElement as je}from"./vidstack-QR8zGkwr-BxbiHRy3.js";const z=le();function o(){return re(z)}const Ke={clickToPlay:!0,clickToFullscreen:!0,controls:["play-large","play","progress","current-time","mute+volume","captions","settings","pip","airplay","fullscreen"],customIcons:!1,displayDuration:!1,download:null,markers:null,invertTime:!0,thumbnails:null,toggleTime:!0,translations:null,seekTime:10,speed:[.5,.75,1,1.25,1.5,1.75,2,4]};var P;class W extends ne{constructor(){super(...arguments);x(this,P)}onSetup(){V(this,P,_()),se(z,{...this.$props,previewTime:M(0)})}}P=new WeakMap,F(W,"props",Ke);function Ue(e,t){const{canAirPlay:a,canFullscreen:n,canPictureInPicture:u,controlsHidden:m,currentTime:$,fullscreen:p,hasCaptions:d,isAirPlayConnected:y,paused:f,pictureInPicture:T,playing:B,pointer:S,poster:A,textTrack:I,viewType:c,waiting:g}=t.$state;e.classList.add("plyr"),e.classList.add("plyr--full-ui");const w={"plyr--airplay-active":y,"plyr--airplay-supported":a,"plyr--fullscreen-active":p,"plyr--fullscreen-enabled":n,"plyr--hide-controls":m,"plyr--is-touch":()=>S()==="coarse","plyr--loading":g,"plyr--paused":f,"plyr--pip-active":T,"plyr--pip-enabled":u,"plyr--playing":B,"plyr__poster-enabled":A,"plyr--stopped":()=>f()&&$()===0,"plyr--captions-active":I,"plyr--captions-enabled":d},R=oe();for(const v of Object.keys(w))R.add(k(()=>void e.classList.toggle(v,!!w[v]())));return R.add(k(()=>{const v=`plyr--${c()}`;return e.classList.add(v),()=>e.classList.remove(v)}),k(()=>{var O;const{$provider:v}=t,D=(O=v())==null?void 0:O.type,q=`plyr--${ze(D)?"html5":D}`;return e.classList.toggle(q,!!D),()=>e.classList.remove(q)})),()=>R.empty()}function ze(e){return e==="audio"||e==="video"}class We extends Ne{async loadIcons(){const t=(await pe(async()=>{const{icons:n}=await import("./vidstack-DXxIKXmd-Dge3KT8k.js");return{icons:n}},[])).icons,a={};for(const n of Object.keys(t))a[n]=Qe({name:n,paths:t[n],viewBox:"0 0 18 18"});return a}}function C(e,t){var a;return((a=e())==null?void 0:a[t])??t}function Xe(){return et()}function Je(){const e=_(),{load:t}=e.$props,{canLoad:a}=e.$state;return ce(()=>t()==="play"&&!a())()?[X(),Q()]:[Ye(),Ze(),Q(),tt(),$t(),bt()]}function X(){const e=_(),{translations:t}=o(),{title:a}=e.$state,n=l(()=>`${C(t,"Play")}, ${a()}`);return s`
    <media-play-button
  ...
  `}function Ye(){const{controls:e}=o();return l(()=>e().includes("play-large")?X():null)}function Ze(){const{thumbnails:e,previewTime:t}=o();return s`
    <media-thumbnail
      .src=${l(e)}
      class="plyr__preview-scrubbing"
      time=${l(()=>t())}
    ></media-thumbnail>
  `}function Q(){const e=_(),{poster:t}=e.$state,a=l(()=>`background-image: url("${t()}");`);return s`<div class="plyr__poster" style=${a}></div>`}function et(){const e=new Set(["captions","pip","airplay","fullscreen"]),{controls:t}=o(),a=l(()=>t().filter(n=>!e.has(n)).map(J));return s`<div class="plyr__controls">${a}</div>`}function tt(){const{controls:e}=o(),t=l(()=>e().map(J));return s`<div class="plyr__controls">${t}</div>`}function J(e){switch(e){case"airplay":return at();case"captions":return nt();case"current-time":return _t();case"download":return yt();case"duration":return Y();case"fast-forward":return pt();case"fullscreen":return st();case"mute":case"volume":case"mute+volume":return dt(e);case"pip":return rt();case"play":return ot();case"progress":return ct();case"restart":return it();case"rewind":return ut();case"settings":return ft();default:return null}}function at(){const{translations:e}=o();return s`
  ...
  `}function it(){const{translations:e}=o(),{remote:t}=_(),a=i(e,"Restart");function n(u){j(u)&&!K(u)||t.seek(0,u)}return s`
    <button
      type="button"
      class="plyr__control"
      data-plyr="restart"
  ...
  `}function ct(){let e=_(),{duration:t,viewType:a}=e.$state,{translations:n,markers:u,thumbnails:m,seekTime:$,previewTime:p}=o(),d=i(n,"Seek"),y=M(null),f=l(()=>{const c=y();return c?s`<span class="plyr__progress__marker-label">${U(c.label)}<br /></span>`:null});function T(c){p.set(c.detail)}function B(){y.set(this)}function S(){y.set(null)}function A(){const c=m(),g=l(()=>a()==="audio");return c?s`
        ...
        `}function I(){var g;const c=t();return Number.isFinite(c)?(g=u())==null?void 0:g.map(w=>s`
        <span
  ...
  `}function _t(){const e=_(),{translations:t,invertTime:a,toggleTime:n,displayDuration:u}=o(),m=M(de(a));function $(d){!n()||u()||j(d)&&!K(d)||m.set(y=>!y)}function p(){return l(()=>u()?Y():null)}return l(()=>{const{streamType:d}=e.$state,y=i(t,"LIVE"),f=i(t,"Current time"),T=l(()=>!u()&&m());return d()==="live"||d()==="ll-live"?s`
          <media-live-button
        ...
        `:s`
          ...
          ></media-time>
          ${p()}
        `})}function Y(){const{translations:e}=o(),t=i(e,"Duration");return s`
    <media-time
      type="duration"
  ...
  `}function Et(e){return l(()=>e()?"true":"false")}function i(e,t){return l(()=>C(e,t))}var b,E,ee;class Z extends ie(Oe,W){constructor(){super(...arguments);x(this,E);x(this,b)}onSetup(){this.forwardKeepAlive=!1,V(this,b,_())}onConnect(){var a;(a=h(this,b).player.el)==null||a.setAttribute("data-layout","plyr"),ue(()=>{var n;return(n=h(this,b).player.el)==null?void 0:n.removeAttribute("data-layout")}),Ue(this,h(this,b)),k(()=>{this.$props.customIcons()?new He([this]).connect():new We([this]).connect()})}render(){return l(N(this,E,ee).bind(this))}}b=new WeakMap,E=new WeakSet,ee=function(){const{viewType:a}=h(this,b).$state;return a()==="audio"?Xe():a()==="video"?Je():null},F(Z,"tagName","media-plyr-layout");r(Z);r(je);r(be);r(fe);r(ve);r(ge);r(Te);r(we);r(he);r(ke);r(Me);r(xe);r(Pe);r(Ee);r(Ce);r(Le);r(Be);r(Se);r(Ae);r(Ie);r(Re);r(De);r(Fe);r(Ge);r(Ve);r(qe);
